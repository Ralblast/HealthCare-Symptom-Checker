...
const conditions: IMedicalCondition[] = [
  {
    ...
    description:
      "The common cold is a viral infection of the upper respiratory tract. It's usually harmless and symptoms typically improve within 7-10 days. Caused by various viruses, most commonly rhinoviruses.",
    recommendations: [
  ...
  },
  {
    ...
    description:
      'Influenza is a contagious respiratory illness caused by influenza viruses. It can cause mild to severe illness and can lead to hospitalization or death in high-risk groups. Flu season typically runs from October to May.',
    recommendations: [
  ...
  },
  {
    ...
    description:
      'A migraine is a neurological condition characterized by intense, debilitating headaches. Episodes typically last 4-72 hours. Often accompanied by visual disturbances (aura) before onset. Affects approximately 15% of the global population.',
    recommendations: [
  ...
  },
  {
    ...
    description:
      'Seasonal allergic rhinitis (hay fever) occurs when the immune system overreacts to outdoor allergens such as pollen from trees, grass, and weeds. Symptoms are seasonal and coincide with pollen counts.',
    recommendations: [
  ...
  },
  {
    ...
    description:
      'Asthma is a chronic respiratory condition where airways become inflamed and narrowed. During an attack, airways produce excess mucus, making breathing extremely difficult. Can be triggered by allergens, exercise, cold air, or stress.',
    recommendations: [
  ...
  },
  {
    ...
    description:
      "Type 2 diabetes is a chronic metabolic condition affecting how the body processes blood glucose (sugar). The body either resists insulin or doesn't produce enough. Can lead to serious complications if untreated, including heart disease, kidney damage, and vision loss.",
    recommendations: [
  ...
  },
  {
    ...
    description:
      'Gastroenteritis is inflammation of the stomach and intestines, typically caused by viral or bacterial infection. Common causes include norovirus, rotavirus, and food poisoning. Usually resolves within 1-3 days.',
    recommendations: [
  ...
  },
  {
    ...
    description:
      'Anxiety disorders involve persistent, excessive worry that interferes with daily activities. Can manifest as generalized anxiety disorder (GAD), panic disorder, or social anxiety. Affects approximately 18% of adults annually.',
    recommendations: [
...
// Seeds the knowledge base once. Safe to call on every boot — it no-ops if the
// collection already has data.
export async function seedMedicalData(): Promise<void> {
  ...
  logger.info('Medical knowledge base seeded', { count: result.length });
}
